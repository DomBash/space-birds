...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    {
        BuyProductID(kProductID100Coins);
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, kProductID100Coins, StringComparison.Ordinal))
        {
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, kProductID1000Coins, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
